            ...
            <div className="row">
                <div className="col-12 col-md-4">
                    <CardPizza
                        ...
                        price={4990}
                        ingredients={["Queso mozarella", "tomates", "jamon", "oregano"]}
                ...
                <div className="col-12 col-md-4">
                    <CardPizza
                        name="Pizza Española"
                        price={5990}
                        ingredients={["Queso mozarella", "gorgonzola", "parmesano", "provolone"]}
...
a1c6-8c57bc388fab"
                ...
                <div className="col-12 col-md-4">
                    <CardPizza
                        ...
                        price={8990}
                        ingredients={["Queso mozarella", "pepperoni", "oregano"]}
                        img="https://firebasestorage.googleapis.com/v0/b/apis-varias-mias.appspot.co
